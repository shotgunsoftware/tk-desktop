...
class Ui_BrowserIntegrationUserSwitchDialog(object):
    def setupUi(self, BrowserIntegrationUserSwitchDialog):
        ...
        BrowserIntegrationUserSwitchDialog.resize(350, 139)
        sizePolicy = QtGui.QSizePolicy(QtGui.QSizePolicy.Fixed, QtGui.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(BrowserIntegrationUserSwitchDialog.sizePolicy().hasHeightForWidth())
        BrowserIntegrationUserSwitchDialog.setSizePolicy(sizePolicy)
    ...
    def retranslateUi(self, BrowserIntegrationUserSwitchDialog):
        BrowserIntegrationUserSwitchDialog.setWindowTitle(QtGui.QApplication.translate("BrowserIntegrationUserSwitchDialog", "Dialog", None, QtGui.QApplication.UnicodeUTF8))
