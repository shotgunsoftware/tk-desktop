...
class Ui_Preferences(object):
    ...
    def retranslateUi(self, Preferences):
        ...
        self.auto_start_label.setToolTip(QtGui.QApplication.translate("Preferences", "When checked Flow Production Tracking Toolkit will startup automatically when you log in.", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.auto_start_checkbox.setToolTip(QtGui.QApplication.translate("Preferences", "When checked Flow Production Tracking Toolkit will startup automatically when you log in.", None, QtGui.QApplication.UnicodeUTF8))
        self.hotkey.setToolTip(QtGui.QApplication.translate("Preferences", "Enter a hotkey that will auto-raise Flow Production Tracking Toolkit when pressed.", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.hotkey_label.setToolTip(QtGui.QApplication.translate("Preferences", "Enter a hotkey that will auto-raise Flow Production Tracking Toolkit when pressed.", None, QtGui.QApplication.UnicodeUTF8))
