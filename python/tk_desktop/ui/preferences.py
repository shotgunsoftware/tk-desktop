...
class Ui_Preferences(object):
    ...
    def retranslateUi(self, Preferences):
        ...
        self.hotkey_label.setToolTip(QtGui.QApplication.translate("Preferences", "Enter a hotkey that will auto-raise Flow Production Tracking when pressed.", None, QtGui.QApplication.UnicodeUTF8))
