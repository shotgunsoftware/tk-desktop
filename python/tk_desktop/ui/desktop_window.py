...
class Ui_DesktopWindow(object):
    def setupUi(self, DesktopWindow):
        ...
        DesktopWindow.resize(450, 756)
        sizePolicy = QtGui.QSizePolicy(QtGui.QSizePolicy.Fixed, QtGui.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(DesktopWindow.sizePolicy().hasHeightForWidth())
        DesktopWindow.setSizePolicy(sizePolicy)
        DesktopWindow.setMinimumSize(QtCore.QSize(450, 450))
        DesktopWindow.setMaximumSize(QtCore.QSize(450, 16777215))
        ...
        self.search_magnifier.setPixmap(QtGui.QPixmap(":/tk-desktop/search.png"))
        ...
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap(":/tk-desktop/ellipses.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap(":/tk-desktop/back_arrow.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap(":/tk-desktop/down_arrow.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.project_menu.setIcon(icon4)
        ...
        icon5 = QtGui.QIcon()
        icon5.addPixmap(QtGui.QPixmap(":/tk-desktop/shotgun_logo_light_medium.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon6 = QtGui.QIcon()
        icon6.addPixmap(QtGui.QPixmap(":/tk-desktop/default_user_thumb.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
    ...
    def retranslateUi(self, DesktopWindow):
        ...
        self.search_button.setToolTip(QtGui.QApplication.translate("DesktopWindow", "Search Projects", None, QtGui.QApplication.UnicodeUTF8))
