...
class Ui_SystemTrayWindow(object):
    def setupUi(self, SystemTrayWindow):
        ...
        SystemTrayWindow.resize(450, 780)
        SystemTrayWindow.setMinimumSize(QtCore.QSize(450, 780))
        SystemTrayWindow.setMaximumSize(QtCore.QSize(450, 780))
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(":/res/default_systray_icon.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        SystemTrayWindow.setWindowIcon(icon)
        SystemTrayWindow.setStyleSheet("")
        SystemTrayWindow.setDockNestingEnabled(False)
        ...
        self.border_layout.setContentsMargins(0, 15, 0, 0)
        ...
        self.app_guis = QtGui.QFrame(self.project_page)
        sizePolicy = QtGui.QSizePolicy(QtGui.QSizePolicy.Preferred, QtGui.QSizePolicy.MinimumExpanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.app_guis.sizePolicy().hasHeightForWidth())
        self.app_guis.setSizePolicy(sizePolicy)
        self.app_guis.setFrameShape(QtGui.QFrame.NoFrame)
        self.app_guis.setFrameShadow(QtGui.QFrame.Plain)
        self.app_guis.setLineWidth(0)
        self.app_guis.setObjectName("app_guis")
        self.verticalLayout_3 = QtGui.QVBoxLayout(self.app_guis)
        self.verticalLayout_3.setSpacing(0)
        self.verticalLayout_3.setContentsMargins(0, 0, 0, 0)
        self.verticalLayout_3.setObjectName("verticalLayout_3")
        self.verticalLayout_2.addWidget(self.app_guis)
        ...
        self.shotgun_arrow = QtGui.QPushButton(self.footer)
        ...
        self.horizontalLayout_3.addWidget(self.shotgun_arrow)
        spacerItem6 = QtGui.QSpacerItem(173, 20, QtGui.QSizePolicy.Expanding, QtGui.QSizePolicy.Minimum)
    ...
    def retranslateUi(self, SystemTrayWindow):
        SystemTrayWindow.setWindowTitle(QtGui.QApplication.translate("SystemTrayWindow", "System Tray", None, QtGui.QApplication.UnicodeUTF8))
        self.apps_button.setText(QtGui.QApplication.translate("SystemTrayWindow", "Apps", None, QtGui.QApplication.UnicodeUTF8))
        self.inbox_button.setText(QtGui.QApplication.translate("SystemTrayWindow", "Inbox", None, QtGui.QApplication.UnicodeUTF8))
        self.my_tasks_button.setText(QtGui.QApplication.translate("SystemTrayWindow", "My Tasks", None, QtGui.QApplication.UnicodeUTF8))
        self.versions_button.setText(QtGui.QApplication.translate("SystemTrayWindow", "Versions", None, QtGui.QApplication.UnicodeUTF8))
        self.subheader_label.setText(QtGui.QApplication.translate("SystemTrayWindow", "<big>PROJECTS</big>", None, QtGui.QApplication.UnicodeUTF8))
        self.project_button.setText(QtGui.QApplication.translate("SystemTrayWindow", "Recent", None, QtGui.QApplication.UnicodeUTF8))
        self.search_text.setPlaceholderText(QtGui.QApplication.translate("SystemTrayWindow", "Search Projects", None, QtGui.QApplication.UnicodeUTF8))
        self.project_name.setText(QtGui.QApplication.translate("SystemTrayWindow", "Project", None, QtGui.QApplication.UnicodeUTF8))
        self.actionQuit.setText(QtGui.QApplication.translate("SystemTrayWindow", "Quit", None, QtGui.QApplication.UnicodeUTF8))
        self.actionQuit.setToolTip(QtGui.QApplication.translate("SystemTrayWindow", "Quit", None, QtGui.QApplication.UnicodeUTF8))
        self.actionQuit.setShortcut(QtGui.QApplication.translate("SystemTrayWindow", "Meta+Q", None, QtGui.QApplication.UnicodeUTF8))
        self.actionPin_to_Menu.setText(QtGui.QApplication.translate("SystemTrayWindow", "Pin to Menu", None, QtGui.QApplication.UnicodeUTF8))
        self.actionSign_Out.setText(QtGui.QApplication.translate("SystemTrayWindow", "Sign Out", None, QtGui.QApplication.UnicodeUTF8))
        self.actionKeep_on_Top.setText(QtGui.QApplication.translate("SystemTrayWindow", "Keep on Top", None, QtGui.QApplication.UnicodeUTF8))
        self.actionAll_Projects.setText(QtGui.QApplication.translate("SystemTrayWindow", "All Projects", None, QtGui.QApplication.UnicodeUTF8))
        self.actionFavorite_Projects.setText(QtGui.QApplication.translate("SystemTrayWindow", "Favorite Projects", None, QtGui.QApplication.UnicodeUTF8))
        self.actionRecent_Projects.setText(QtGui.QApplication.translate("SystemTrayWindow", "Recent Projects", None, QtGui.QApplication.UnicodeUTF8))
        self.actionProject_Filesystem_Folder.setText(QtGui.QApplication.translate("SystemTrayWindow", "Project Filesystem Folder", None, QtGui.QApplication.UnicodeUTF8))
