...
# The osutils extension modules from the Flow Production Tracking Toolkit's private repo.
if sys.platform.startswith("linux"):

    # The Flow Production Tracking Toolkit that comes with PySide2 does not require
    # any helper code to have the application move the foreground
    # properly.
    try:
        import PySide2  # noqa
    except Exception:
        # We're in a PySide 1 version of Flow Production Tracking Toolkit, so try
