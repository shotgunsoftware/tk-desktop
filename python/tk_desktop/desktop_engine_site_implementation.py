...
class DesktopEngineSiteImplementation(object):
    ...
    def run(self, splash, version, **kwargs):
        ...
        :param version: Version of the PTR desktop app installer code.
        ...
        # can cause a crash when running PTR desktop app installer 1.02 code. We used to
        ...
        if kwargs.get("server") is not None:
            logger.warning(
                "You are running an older version of the PTR desktop app which is not fully compatible "
