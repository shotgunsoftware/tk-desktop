...
class DesktopEngineSiteImplementation(object):
    ...
    def run(self, splash, version, **kwargs):
        ...
        :param version: Version of the Flow Production Tracking installer code.
        ...
        # can cause a crash when running Flow Production Tracking installer 1.02 code. We used to
        ...
        try:
            # Log usage statistics about the Flow Production Tracking executable and the desktop startup.
            #
        ...
        if server is None:
            ...
            # styled after the Flow Production Tracking's visual-style.
            if splash:
        ...
        if kwargs.get("server") is not None:
            logger.warning(
                "You are running an older version of the Flow Production Tracking which is not fully compatible "
    ...
    def uses_legacy_authentication(self):
        """
        Returns if the Flow Production Tracking installed code uses the tk-framework-login for
        logging in.
        ...
        #
        # Since Python 3 builds of the Flow Production Tracking and greater do not support
    ...
    def create_legacy_login_instance(self):
        ...
        tk-framework-login to authenticate in the Flow Production Tracking's installer
        ...
        In the Flow Production Tracking installer v1.1.0 code and higher, this
