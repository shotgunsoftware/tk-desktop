...
"""
Flow Production Tracking Toolkit project-level engine implementation.
"""
...
class DesktopEngineProjectImplementation(object):
    """
    Launches an RPC server which listens for requests from the Flow Production Tracking Toolkit to launch an app.
    """
